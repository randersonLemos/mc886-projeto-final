...
from classes.wrapperbinaryclassifier import WrapperBinaryClassifier
...
if __name__ == '__main__':
    ...
    WrapperBinaryClassifier.set_augmentation_layers(augmentation_layers)

    wrapper = WrapperBinaryClassifier(
          myDataset=ds
    ...
    #wrapper.fine_tune(fine_tune_at=25, fine_tune_epochs=10).results()

    #test_dataset = ds.test
    #if test_dataset.cardinality().numpy() == 0:
    #    test_dataset = ds.train

    #loss, accuracy = wrapper.model.evaluate(test_dataset)
